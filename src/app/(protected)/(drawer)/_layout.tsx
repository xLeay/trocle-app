...
export default function Layout() {
    ...
    const screenOptions = useMemo(() => ({
        ...
        swipeEdgeWidth: 100, // De combien de pixels on peut partir du bord pour déclencher le drawer
        swipeMinDistance: 0, // De combien de pixels il faut glisser pour ouvrir le drawer
