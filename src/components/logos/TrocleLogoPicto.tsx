...
const TrocleLogoPicto = forwardRef<React.ElementRef<typeof Svg>, Props>(
    ({ variant = 'medium', color = 'trocle', ...props }, ref) => {
        const { theme } = useTheme();

        let colors = COLOR_MAP[color];
...
TrocleLogoPicto.displayName = 'TrocleLogoPicto';
