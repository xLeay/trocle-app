...
const surface = {
    light: {
        ...
        accentSecondary: color.accent._50,
        accentecondaryLight: color.accentSecondary._90,
        blue: color.blue._50,
    ...
    dark: {
        ...
        accentSecondary: color.accent._60,
        accentecondaryLight: color.accentSecondary._40,
        blue: color.blue._70,
